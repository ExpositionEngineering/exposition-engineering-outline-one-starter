# 🎤 Exposition Engineering: Show Outline One
...
[writing/outlines/show_outline_one.md](writing/outlines/show_outline_one.md),
...
[exposition-engineering-outline-one-starter](https://github.com/ExpositionEngineering/exposition-engineering-outline-one-starter);
...
read all of the `TODO` markers inside of the `show_outline_one.md` file and
...
technical writing prompts in the `writing/outlines/show_outline_one.md` file.
